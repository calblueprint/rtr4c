...
class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :date, :description, :location, :volunteers, designers_attributes: [:id, :name, :url, :_destroy], images_attributes: [:id, :name, :photo, :phototype, :_destroy])
    end
end
